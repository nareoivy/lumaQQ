 ...
 * @author luma
 */
class HtmlRecordExporterFactory {
		...
		if(exporter == null) {
			switch(exportType) {
				case IRecordExporter.EXPORT_FRIEND:
					exporter = new FriendHtmlRecordExporter();
					break;
				case IRecordExporter.EXPORT_CLUSTER:
					exporter = new ClusterHtmlRecordExporter();
					break;
				case IRecordExporter.EXPORT_SYSTEM:
					exporter = new SystemHtmlRecordExporter();
					break;
				case IRecordExporter.EXPORT_SMS:
					exporter = new SMSHtmlRecordExporter();
					break;
			}
