 ...
 * @author luma
 */
public class SystemMessageLabelProvider implements IWaterfallLabelProvider {
	...
	public String getText(Object element) {
		...
		String date = DateTool.format(entry.time) + "  10000";
		return date + CRLF + entry.message;
	}

	public void installStyle(Object element, TextLayout layout) {
		RecordEntry entry = (RecordEntry)element;
		String date = DateTool.format(entry.time) + "  10000";
		layout.setStyle(STYLE, 0, date.length() - 1);
	}
