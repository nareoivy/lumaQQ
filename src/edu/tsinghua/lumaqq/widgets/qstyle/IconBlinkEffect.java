 ...
 * @author luma
 */
class IconBlinkEffect implements IEffect {
	public static final IEffect INSTANCE = new IconBlinkEffect();
	...
	private void paintHorizontal(QItem item, GC gc, int y, int frame) {
		...
		// 偶数帧画图标
		item.paintIcon(gc, (frame % 2 == 0) ? item.getImage() : null, item.imageBound, imageX, imageY, size);
